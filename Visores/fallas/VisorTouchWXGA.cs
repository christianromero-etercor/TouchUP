...
namespace TouchUP.Visores
{
    public partial class VisorTouchWXGA : Form
    {
        ...
        public void llenar_tablaAA(string fallas = "")
        {
            ...
            foreach (DataGridViewRow row in this.dataGridAA.Rows)
            {
                ...
                if (Convert.ToInt32(row.Cells[dataGridAA.Columns[5].Index].Value) >= 3)
                {
                    ...
                    {
                        this.panelAA.Width = 1366;
                        this.panelAA.Location = new Point(0, 180);
                    }
                    else
                    {
                        this.panelAA.Width = 683;
                        this.panelAA.Location = new Point(0, 180);
                    }
        ...
        public void llenar_tablaTV(string fallas = "")
        {
            ...
            foreach (DataGridViewRow row in this.dataGridTV.Rows)
            {
                ...
                if (Convert.ToInt32(row.Cells[dataGridTV.Columns[5].Index].Value) >= 3)
                {
                    ...
                    {
                        this.panelTV.Width = 1366;
                        this.panelTV.Location = new Point(0, 180);
                    }
                    else
                    {
                        this.panelTV.Width = 683;
                        this.panelTV.Location = new Point(683, 180);
                    }
        ...
        private void VisorTouchWXGA_Deactivate(object sender, EventArgs e)
        {
        ...
        private void VisorTouchWXGA_Activated(object sender, EventArgs e)
        {
