...
namespace TouchUP.Visores.operario
{
    ...
    public partial class DisplayOperarioAA : Form
    {
        ...
        public DisplayOperarioAA()
        {
            ...
            {
                this.Text = "TouchUP" + " v" + Application.ProductVersion.Substring(0, 3) + " - Selector de placas para puesto de AA (Operario)";
            }
        }
        ...
        private void cargarMarca()
        {
            ...
            string consulta = "SELECT DISTINCT Marca FROM Maestro_Articulos WHERE Puesto = 'AA'";
        ...
        private void cargaModelo(string Marca)
        {
            ...
            string consulta = "SELECT DISTINCT Modelo FROM Maestro_Articulos WHERE Marca = '" + Marca + "' AND Puesto = 'AA'";
        ...
        private void cargaPlaca(string Marca, string Modelo)
        {
            ...
            string consulta = "SELECT DISTINCT Placa FROM Maestro_Articulos WHERE Marca = '" + Marca + "' AND Modelo = '" + Modelo + "' AND Puesto = 'AA'";
        ...
        {
            string consulta = "SELECT Imagen FROM Maestro_Articulos WHERE Marca = '" + Marca + "' AND Modelo = '" + Modelo + "' AND Placa = '" + Placa + "' AND Puesto = 'AA'";
                ...
                case "PCB INVERTER 3200":
                    {
                        ...
                        pcbinverter3200.Show();
                        break;
                    }
                case "PCB MAIN 3200 INVERTER":
                    {
                        string Modelo = CmbModelo.SelectedItem.ToString();
                        string Placa = CmbPlaca.SelectedItem.ToString();
                        ...
                        TouchUP.Placas.AA.PCB_MAIN_INVERTER_3200 pcbmaininverter3200 = new Placas.AA.PCB_MAIN_INVERTER_3200(Modelo, Placa);
                        pcbmaininverter3200.Show();
                        break;
                    }
                case "PCB DISPLAY 3200 INVERTER":
                    {
                        string Modelo = CmbModelo.SelectedItem.ToString();
                        string Placa = CmbPlaca.SelectedItem.ToString();
                        ...
                        TouchUP.Placas.AA.PCB_DISPLAY_INVERTER_3200 pcbdisplayinverter3200 = new Placas.AA.PCB_DISPLAY_INVERTER_3200(Modelo, Placa);
                        pcbdisplayinverter3200.Show();
                        break;
                    }
